...
import { MODULES, CONCEPTS } from '../config/modules';
...
const LESSON_CONTENT = {
    ...
    3: {
        ...
        tabs: [
            { name: 'Learn', description: 'Learn template design principles' },
            { name: 'Build', description: 'Build new context templates' },
            { name: 'Library', description: 'Manage saved templates' },
            { name: 'Import', description: 'Import insights from other lessons' },
        ],
    },
    4: {
        ...
        tabs: [
            { name: 'Learn', description: 'Learn context documentation practices' },
            { name: 'Manage', description: 'Create and manage context docs' },
            { name: 'Sessions', description: 'Track update sessions over time' },
            { name: 'View', description: 'View and share doc contents' },
        ],
    },
    5: {
        ...
        tabs: [
            ...
            { name: 'Library', description: 'Saved output types and ratings' },
            { name: 'Insights', description: 'Calibration insights and trends' },
        ],
    },
    6: {
        ...
        skill: 'Create reusable verification checklists tied to output types. Track which checks actually catch issues to refine your process over time. Define clear skip criteria for trusted outputs.',
        tabs: [
            { name: 'Checklists', description: 'Create verification checklists' },
            { name: 'Practice', description: 'Practice verification workflows' },
            { name: 'Library', description: 'Saved checklists for reuse' },
            { name: 'Import', description: 'Import output types from Lesson 5' },
        ],
    },
    7: {
        ...
        tabs: [
            { name: 'Learn', description: 'Learn decomposition frameworks' },
            { name: 'Decompose', description: 'Break down a project into tasks' },
            { name: 'Library', description: 'Saved decompositions' },
        ],
    },
    8: {
        ...
        tabs: [
            { name: 'Learn', description: 'Learn delegation best practices' },
            { name: 'Delegations', description: 'Create delegation briefs' },
            { name: 'Execution', description: 'Execute and track task sequences' },
            { name: 'Import', description: 'Import decompositions from Lesson 7' },
        ],
    },
    9: {
        ...
        tabs: [
            { name: 'Learn', description: 'Learn the 70-85-95 iteration framework' },
            { name: 'Practice', description: 'Practice structured iteration passes' },
            { name: 'Library', description: 'Saved iteration sessions' },
            { name: 'Import', description: 'Import conversations to iterate on' },
        ],
    },
    10: {
    ...
    11: {
        ...
        tabs: [
            { name: 'Learn', description: 'Learn frontier recognition concepts' },
            { name: 'Zones', description: 'Map AI reliability zones' },
            { name: 'Encounters', description: 'Log frontier encounters' },
            { name: 'Stats', description: 'View statistics and patterns' },
            { name: 'Import', description: 'Import data from Lesson 5' },
        ],
    },
    12: {
        ...
        tabs: [
            { name: 'Learn', description: 'Learn about reference cards' },
            { name: 'Card', description: 'Generate your personal reference card' },
            { name: 'Progress', description: 'Track progress across all lessons' },
        ],
    },
};
    ...
    return (
        <div className="curriculum-page">
            <div className="page-header">
                <h1 className="page-title">Curriculum Overview</h1>
                <p className="page-description">
                    12 hands-on lessons across 4 modules. Each lesson targets a specific managerial AI skill through interactive exercises, building systematic habits for effective AI collaboration.
                </p>
            </div>
